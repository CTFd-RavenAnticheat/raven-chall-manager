...
func NewExposedMonopod(ctx *pulumi.Context, name string, args *ExposedMonopodArgs, opts ...pulumi.ResourceOption) (*ExposedMonopod, error) {
	...
	sub, err := newExposedMultipod(ctx, ExposedMultipodArgs{
		...
		ChallengeID:      argsOut.ChallengeID(),
		PacketCapturePVC: argsOut.PacketCapturePVC(),
		Label:            argsOut.Label(),
...
func (o ExposedMonopodArgsOutput) ChallengeID() pulumi.StringOutput {
	return o.ApplyT(func(args ExposedMonopodArgsRaw) string {
		return args.ChallengeID
	}).(pulumi.StringOutput)
}

func (o ExposedMonopodArgsOutput) PacketCapturePVC() pulumi.StringPtrOutput {
	return o.ApplyT(func(args ExposedMonopodArgsRaw) *string {
