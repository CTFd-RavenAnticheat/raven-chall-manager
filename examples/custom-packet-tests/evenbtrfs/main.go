...
func main() {
	sdk.Run(func(req *sdk.Request, resp *sdk.Response, opts ...pulumi.ResourceOption) error {
		...
		cm, err := k8s.NewExposedMonopod(req.Ctx, "test", &k8s.ExposedMonopodArgs{
			...
			Hostname:         pulumi.String("172.18.0.2"),
			Container: k8s.ContainerArgs{
				Image: pulumi.String("registry.gitlab.com/bitravens1/darkesthour26/evenbtrfs"),
				Ports: k8s.PortBindingArray{
					k8s.PortBindingArgs{
						Port:       pulumi.Int(1001),
		...
		resp.ConnectionInfo = pulumi.Sprintf("nc %s",
			cm.URLs.MapIndex(pulumi.String("1001/TCP")))
